                ...
                <div className="h-[400px] grid grid-cols-6 gap-10 pt-3">
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    <input
                      ...
                      required
                      className="appearance-none bg-gray-200 py-1 w-full rounded-xl border-gray-300"
                    />
                  </div>
                  <div className="col-span-6 sm:col-span-3">
                    {/* <label
                    ...
                    <input
                      ...
                      required
                      className="appearance-none w-full bg-gray-200 py-1 rounded-xl border-gray-300"
                    />
                  </div>
