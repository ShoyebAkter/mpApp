        ...
        <form className="bg-white p-10  rounded-xl text-white" onSubmit={handleSubmit(onSubmitForm)}>
          <div className="relative mb-6">
            ...
            {...register("type")}
              ...
              required
              // value={mobileNumber}
              type="text" id="input-group-1" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="Campaign Type" />
          </div>
          <div className="relative mb-6">
            <input
            {...register("phone")}
              ...
              required
              // value={mobileNumber}
              type="number" id="input-group-1" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="To: +8801 with country code" />
          </div>
